...
@Component({
  selector: 'app-invite-collegue-dialog',
  templateUrl: './invite-collegue-dialog.component.html',
  styleUrls: ['./invite-collegue-dialog.component.sass']
})
export class InviteCollegueDialogComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<InviteCollegueDialogComponent>,
